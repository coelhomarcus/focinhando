   ...
   return (
      ...
      >
         <div className='text-center'>
            <h1 className='text-4xl md:text-6xl font-bold mb-4'>Encontre seu novo <span className='text-focinhando-green'>amigo</span>!</h1>
            <p className='text-xl md:text-2xl'>Uma plataforma simples para adoção de pets</p>
         </div>
      </section>
   )
}
